...
import static com.example.audioanalyzer.SamplingLoop.sendToServer;
               ...
               OnItemClickListener, AnalyzerGraphic.Ready
{
    ...
    static volatile boolean bSaveWav, startRecording = false;
...
//        }
    ...
    private void loadPreferenceForView() {
        ...
        // list-buttons
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(this);
        analyzerParam.sampleRate   = sharedPref.getInt("button_sample_rate", 44100);
